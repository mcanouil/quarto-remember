...
Scroll to the bottom of this page, follow a link to another page, then come back: you should land where you were rather than at the top.
To see the prompt instead, close the tab after scrolling and open the page again.
A tab that has already moved around the site restores the position without asking; a new one asks, and says how long ago the visit was.
:::
